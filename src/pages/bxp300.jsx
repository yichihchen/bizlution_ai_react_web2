...
import Bxp300tab from "../components/bxp300_tab";
        ...
        <>
            ...
            <Devicesidebar />
                <div className="bg-white rounded-xl my-28">
                    {/* 可能要插入sidebar */}
                    <h4 className="text-2xl sm:text-4xl md:text-6xl font-bold pt-20 text-center">BXP-300 超4K畫質推播廣告機</h4>
