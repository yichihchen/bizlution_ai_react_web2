...
import Sbc320tab from "../components/sbc320_tab";
    ...
    <>
      ...
      <div className="container">
        ...
        <div className="bg-white rounded-xl my-28">
          <h4 className="text-2xl sm:text-4xl md:text-6xl font-bold pt-20 text-center">SBC-320 超4K畫質推播廣告機</h4>
          ...
          <section className="p-10 md:p-20 flex-none lg:flex justify-evenly">
            ...
            <div className="device-brief">
              ...
              <ul className="text-xl sm:text-xl md:text-2xl space-y-3">
                ...
                <li>商務Andriod 13作業系統</li>
                <li>支援旋轉播放直立顯示</li>
                <li>無風扇設計安靜輕巧</li>
                <li>低碳排放節能省電</li>
                <li>內建32GB儲存空間</li>
                <li>開機系統自動錯誤偵測</li>
                <li>搭載SignCMS軟體直覺操作</li>
                <li>適合開發人員應用多元整合</li>
              </ul>
            </div>
