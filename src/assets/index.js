...
//Import process
import check from "./process/check.svg";
import database from "./process/database.svg";
import modelplan from "./process/modelplan.svg";
import settings from "./process/settings.svg";
