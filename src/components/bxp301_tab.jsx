...
import Bxp301tabledownload from './bxp301_table_download';
import Bxp301tablespecifiction from "./bxp301_table_specification";
                        ...
                        <div className="w-full px-0 md:px-4">
                            <div className="mb-14 w-full">
                                ...
                                <TabContent1
                                    ...
                                    subtitle8="SignEffex 微型商務系統"
                                    subtitle8details="您可以搭配使用我們的SignEffex的微型商務管理軟體，提供四大功能輕鬆完成編輯、排程、傳輸與管理。滿足各種食衣住行等空間消費的小型商務使用。"
