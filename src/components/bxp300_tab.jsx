...
import Bxp300tabledownload from '../components/bxp300_table_download';
import Bxp300tablespecifiction from "../components/bxp300_table_specification";

import UHD from "../assets/images/devices/bxp300_pages/UHD.jpg";
import wrotation from "../assets/images/devices/bxp300_pages/w-rotation.jpg";
import ble from "../assets/images/devices/bxp300_pages/ble.jpg";
import fhd100wifi from "../assets/images/devices/bxp300_pages/fhd100-wifi.jpg";
import smil from "../assets/images/devices/bxp300_pages/p_smil.jpg";
import stable from "../assets/images/devices/bxp300_pages/stable.jpg";
import plug from "../assets/images/devices/bxp300_pages/off-by-plug.jpg";
import signeffexbundle from "../assets/images/devices/bxp300_pages/signeffex-bundle.jpg";
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-0 md:px-4">
                            <div className="mb-14 w-full">
                                ...
                                <TabContent1
                                    title="4K UHD的極致細膩畫質"
                                    details=" 高清屏幕 4K UHD 解析度可高達一般FHD(1920x1080)的四倍畫質，超越視網膜帶來身臨其境的視覺體驗，讓畫面細膩變化栩栩如生，讓您的商品精華耀眼。"

                                    subtitle1="直立式四向支援"
                                    subtitle1details="採用Andriod Screen螢幕旋轉提供最佳的顯示器方向設定，能滿足直接90至360度共四個螢幕方向定位，不需再特別處理煩惱你的影像圖片的自行後製轉向，直接就能完整直立顯示。若你有直立式螢幕播放需求，務必挑選這款！"

                                    subtitle2="提供iBeacon (BLE)"
                                    subtitle2details="使用廣告機也能兼差當iBeacon傳輸器使用，你可以輕易的將商品打入大型空間，結合自行開發應用始做為室內微定位可能，滿足行銷與導覽應用。適合具備商用程式開發的設計群朋友。"

                                    subtitle3="內建無線網路Wi-Fi"
                                    subtitle3details="支援無線傳輸的實際需求，提供802.11b/g/n Wi-Fi無線網路模組，適用於各種不適合施工的商用空間應用。使用彈性更上一階。"

                                    subtitle4="HTML5+SMIL開發需求"
                                    subtitle4details="可做速成開發的HTML5掛載應用。降低門檻提供有效的第三方整合設計。適合做為Web看板考量。另釋出API完整XML控制碼。以W3C的SMIL做為基礎標準延伸，供各種客製化的看板設計，創造更加樣的看板定位。"

                                    subtitle5="商用嚴苛耐用等級"
                                    subtitle5details="外殼採用硬化塗層的全金屬機身無風扇設計，高溫耐久能抵抗外在干擾的嚴苛環境。機身更輕薄並安靜無聲。"

                                    subtitle6="自動斷電防護設計"
                                    subtitle6details="沒有多餘電源紐，只要通電就能自我開機作業，因為有內建WatchDog Timer工具能不斷修復並保護系統運作資源，您可以大膽放心關閉展示間的總電源，下次送電繼續運作。"

                                    subtitle7="SignEffex 微型商務系統"
                                    subtitle7details="您可以搭配使用我們的SignEffex的微型商務管理軟體，提供四大功能輕鬆完成編輯、排程、傳輸與管理。滿足各種食衣住行等空間消費的小型商務使用。"
                                    tabCategory="home"
                                    open={open}
                                />
                                <TabContent2
...
const TabContent1 = ({ open,
    ...
    return (
        <div>
            <div
                className={`p-6 text-base leading-relaxed dark:text-dark-4 ${open === tabCategory ? "block" : "hidden"
                    } `}
            >
                <div className="my-16">
                ...
                <div className="my-16">
                    ...
                    <img src={signeffexbundle} alt="signeffexbundle" />
                </div>
    ...
    return (
        <div>
            ...
            >
                ...
                {/* download sofeware */}
                <div className="container">
                    <h4 className="text-3xl md:text-4xl font-bold">播放器軟體下載 SignEffeX</h4>
                    <section className="">
                        <div className="container">
