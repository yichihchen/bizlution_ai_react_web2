                    ...
                    <div className='w-full '>
                        <div className='max-w-full overflow-x-auto'>
                            <table className='w-full table-auto'>
                                ...
                                <tbody>
                                    <tr>
                                        <td className={TdStyle.TdStyle}>SBC-320 硬體規格 (CHT)</td>
                                        <td className={TdStyle.TdStyle2}>SBC-320-CHT.compressed.pdf</td>
                                        <td className={TdStyle.TdStyle}>2025-01-01</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
export default Sbc320tabledownload;
