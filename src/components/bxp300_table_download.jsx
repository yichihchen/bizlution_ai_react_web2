                    ...
                    <div className='w-full '>
                        <div className='max-w-full overflow-x-auto'>
                            <table className='w-full table-auto'>
                                ...
                                <tbody>
                                    <tr>
                                        <td className={TdStyle.TdStyle}>BXP-300 硬體規格 (CHT)</td>
                                        <td className={TdStyle.TdStyle2}>BXP-300-CHT.compressed.pdf</td>
...
export default Bxp300tabledownload;
